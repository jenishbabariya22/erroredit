...
import { Adduser, edituser, updateuser, viewuser } from '../action/action'
        ...
        <div id="login" className="w-64 h-80 bg-indigo-50 rounded shadow flex flex-col justify-between p-3">
          <form className="text-indigo-500" action method="post">
            <fieldset className="border-4 border-dotted border-indigo-500 p-5">
              ...
              <button onClick={submit} type='button' className="w-full rounded bg-indigo-500 text-indigo-50 p-2 text-center font-bold hover:bg-indigo-400">Edit</button>
            </fieldset>
          </form>
        </div>
